...
public class GBig {
  public static let traditionalChinese =
  ...
  public static let simplifiedChinese =
  ...
  public static func simplify(_ chinese: String) -> String {
    return String(chinese.map { chart in
      if let index = traditionalChinese.index(of: chart) {
  ...
  public static func traditionalize(_ chinese: String) -> String {
    return String(chinese.map { chart in
      if let index = simplifiedChinese.index(of: chart) {
        return traditionalChinese[index]
      } else {
        return chart
      }
    })
...
public extension String {
  public var traditionalizeGb: String {
    return GBig.traditionalize(self)
  }
  public var simplifyGb: String {
